...
def post_thread_with_text(text):
    ...
    container_response = requests.post(container_creation_url, params=container_params, verify=False).json()
    ...
    post_response = requests.post(post_url, params=post_params, verify=False).json()
