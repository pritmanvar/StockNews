...
{description}"""
    ...
    return detailed_news, True if page_content else False    
    
get_news_details(urls[0], "zee bussiness", "Power of Compounding: How soon you can generate Rs 1.5 crore corpus with monthly investments of Rs 1,500, Rs 2,500, or Rs 3,500")